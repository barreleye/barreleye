...
use barreleye_common::{
	models::{
		set, Address, AddressActiveModel, AddressColumn, BasicModel, PrimaryId,
	},
	App,
};
...
pub async fn handler(
	...
	// get all addresses
	let all_addresses = Address::get_all_where(
		app.db(),
		AddressColumn::Id.is_in(payload.addresses),
	)
	.await?;
